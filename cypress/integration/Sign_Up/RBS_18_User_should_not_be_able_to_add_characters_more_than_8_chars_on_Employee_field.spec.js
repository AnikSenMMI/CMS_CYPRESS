...
describe("RBS_18_User_should_not_be_able_to_add_characters_more_than_8_chars_on_Employee_field",()=>{
    afterEach("waiting",() => {
    ...
    it ("input Employee id with more than 8 character", ()=>
    {
        base.writting_on_input_with_xpath(base_locator.employee_id_field, SignUp_page.employee_id_with_more_than_8_charachter)
    })

    it("assertion--> Employee field doesn't has any character in it", ()=>
    {
        cy.xpath(base_locator.employee_id_field).invoke('attr','value').should('have.length', 8)
